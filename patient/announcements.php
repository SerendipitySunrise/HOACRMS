...
/**
 * announcements.php
 * CarePath - Patient Announcements
 */
...
if ($roleName !== null && strcasecmp(trim((string) $roleName), 'Patient') !== 0) {
...
<title>Announcements — CarePath Patient Portal</title>
...
<style>
  ...
  .btn-mark-all-read:hover { text-decoration: underline; }
</style>
</head>
<body>
<div class="app">
  ...
  <aside class="sidebar">
    ...
    <ul class="nav-list">
      ...
      <li class="nav-item">
        <a href="consultation_history.php">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v5h5"/><path d="M3.05 13A9 9 0 1 0 6 5.3L3 8"/><polyline points="12 7 12 12 16 14"/></svg>
          History
        </a>
      </li>
      <li class="nav-item">
  ...
  <main class="main">
    ...
    <div class="page-header">
      <div style="display:flex; align-items:center; justify-content:space-between; gap:16px; flex-wrap:wrap;">
        <div>
          <h1>Announcements</h1>
          <p>Health center news and important notices</p>
        </div>
            ...
            <div class="announcement-card-foot">
              ...
              <?php else: ?>
                <form method="POST">
                  ...
                  <button type="submit" class="btn-mark-all-read" style="font-size:0.8rem;">Mark as read</button>
                </form>
              <?php endif; ?>
            </div>
          </div>
