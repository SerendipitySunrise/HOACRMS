...
<title>Announcements — Curora Staff Portal</title>
  ...
  <aside class="sidebar">
    ...
    <ul class="nav-list">
      ...
      <li class="nav-item active">
        <a href="announcements.php" style="text-decoration:none;color:inherit;display:flex;align-items:center;gap:12px;">
